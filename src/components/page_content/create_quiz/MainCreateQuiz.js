...
function MainCreateQuiz() {
  ...
  const blocker = useBlocker(({ currentLocation, nextLocation }) => {
    return (
      !formNavigate &&
      currentLocation.pathname !== "/kreiraj-kviz" &&
      currentLocation.pathname !== "/kreiraj-kviz/" &&
      currentLocation.pathname !== nextLocation.pathname &&
      nextLocation.pathname !== "kreiraj-kviz" &&
      nextLocation.pathname !== "/kreiraj-kviz/nova-runda" &&
  ...
  return (
    <div
      ...
      className="flex justify-center items-center h-screen sm:h-screen md:h-screen w-full md:w-[88vw] lg:w-[84vw] absolute right-0 z-0 p-0 m-0"
    >
